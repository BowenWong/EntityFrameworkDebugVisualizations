...
namespace EntityFramework.Debug.DebugVisualization.Views.AttachedBehaviours
{
	public static class DragBehaviour
    {
	    ...
	    private static void OnIsDragEnabledPropertyChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
	    {
	        ...
	        if ((bool) e.NewValue)
	        {
	            ...
	            System.Diagnostics.Debug.WriteLine("DragBehaviour registered.", "WPFExt");
	        }
	        else
	        {
	            ...
	            System.Diagnostics.Debug.WriteLine("DragBehaviour unregistered.", "WPFExt");
	        }
	    }
	    ...
	    private static void OnDragStarted(object sender, MouseButtonEventArgs e)
	    {
	        ...
	        System.Diagnostics.Debug.WriteLine("Drag started on object: " + obj, "WPFExt");
	    ...
	    private static void OnDragFinished(object sender, MouseButtonEventArgs e)
	    {
	        ...
	        System.Diagnostics.Debug.WriteLine("Drag finished on object: " + obj, "WPFExt");
